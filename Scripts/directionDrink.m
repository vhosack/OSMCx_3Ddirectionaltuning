...
ttpt_r = {}; neural_r = {}; cycles_r = {}; Cycles_r = {}; times_r = {};
for i = 1:ntrials
    ...
    Mins = [ttpt_r{i}(:,1), ttpt_r{i}(:,2), ttpt_r{i}(:,3)]; mins = Mins(minstretch_r,:);
    Maxs = [ttpt_r{i}(:,1), ttpt_r{i}(:,2), ttpt_r{i}(:,3)]; maxs = Maxs(maxstretch_r,:);
...
ttpt_m = {}; neural_m = {}; cycles_m = {}; Cycles_m = {}; times_m = {};
for i = 1:ntrials
    ...
    Mins = [ttpt_m{i}(:,1), ttpt_m{i}(:,2), ttpt_m{i}(:,3)]; mins = Mins(minstretch_m,:);
    Maxs = [ttpt_m{i}(:,1), ttpt_m{i}(:,2), ttpt_m{i}(:,3)]; maxs = Maxs(maxstretch_m,:);
...
ttpt_l = {}; neural_l = {}; cycles_l = {}; Cycles_l = {}; times_l = {};
for i = 1:ntrials
    ...
    Mins = [ttpt_l{i}(:,1), ttpt_l{i}(:,2), ttpt_l{i}(:,3)]; mins = Mins(minstretch_m,:);
    Maxs = [ttpt_l{i}(:,1), ttpt_l{i}(:,2), ttpt_l{i}(:,3)]; maxs = Maxs(maxstretch_l,:);
...
spikecount = {}; meanfiring = {}; timespikes = {}; spktimes = {};
for u = 1:length(Units)
    ...
    for dir = 1:length(NeuralBefore)
        ...
        for t = 1:length(trials)
            cycles = trials{t}; cycles = cell2mat(cycles);
...
spikecount = {}; timespikes = {}; meanfiring = {}; spktimes = {};
for u = 1:length(Units)
    temp = Units{u}.times;
    for dir = 1:length(NeuralBefore)
        trials = NeuralBefore{dir};
