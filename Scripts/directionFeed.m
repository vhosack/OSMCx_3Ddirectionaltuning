...
%%
% Nerve Block
M1F = load('20190227_M1F_sortedspikes.mat'); %% paths to neural data
M1U = load('20190227_M1U_sortedspikes.mat');
M1F = struct2cell(M1F); 
M1U = struct2cell(M1U);
Units = [M1F; M1U];
% Units = M1F; %% run individual area
...
%%
% Nerve Block
S1F = load('20190227_S1F_sortedspikes.mat'); %% paths to neural data
S1U = load('20190227_S1U_sortedspikes.mat');
S1F = struct2cell(S1F); 
S1U = struct2cell(S1U);
Units = [S1F; S1U];
